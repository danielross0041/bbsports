                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>                  
                        <ul>
                            ...
                            <li class="{{ Request::path()=='attributes'? 'active': '' }}"><a href="{{route('roles')}}"><i class="icon-layers"></i> Attributes</a></li>
                            @endif
                            @if($sidebar_data)
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-layers mr-1"></i> Web Apps</a>                  
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><i class="icon-options"></i>Website Settings</a>
                                <ul class="sub-menu">
                                    <li><a href="{{route('web_config')}}"><i class="icon-energy"></i> Config</a></li>
                                    <li><a href="{{route('logo')}}"><i class="icon-energy"></i> Logo</a></li>
                                </ul>
                            </li> 
